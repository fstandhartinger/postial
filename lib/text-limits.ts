...
export function channelTextLimit(channel: { provider: string; meta?: { maxTextLength?: number } }) {
  return channel.provider === 'mastodon' ? channel.meta?.maxTextLength ?? 500 : channel.provider === 'bluesky' ? 300 : channel.provider === 'telegram' ? 4096 : channel.provider === 'x' ? 280 : channel.provider === 'threads' ? 500 : channel.provider === 'linkedin' ? 3000 : channel.provider === 'facebook' ? 63206 : channel.provider === 'instagram' ? 2200 : 0;
}
