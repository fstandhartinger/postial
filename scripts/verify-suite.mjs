...
try {
  ...
  const db = ['funnel', 'entitlements', 'workspace', 'webhook', 'publishers', 'ssrf-boundary', 'core', 'api', 'openapi', 'oauth', 'pilot', 'retention', 'bulk', 'c6', 'c7', 'deletion-sweep', 'signin-ratelimit', 'signin-visibility.ts', 'fixer3-migration', 'worker-drain', 'trial-end', 'error-visibility', 'deployment-skew.tsx', 'trial-handoff.tsx'];
