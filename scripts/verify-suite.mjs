...
try {
  ...
  const db = ['funnel', 'funnel-client-class', 'entitlements', 'workspace', 'webhook', 'publishers', 'docs-truth', 'ssrf-boundary', 'core', 'api', 'openapi', 'oauth', 'pilot', 'retention', 'bulk', 'c6', 'c7', 'deletion-sweep', 'signin-ratelimit', 'signin-visibility.ts', 'fixer3-migration', 'worker-drain', 'trial-end', 'trial-reminder', 'error-visibility', 'deployment-skew.tsx', 'trial-handoff.tsx'];
