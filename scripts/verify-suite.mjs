...
try {
  ...
  const db = ['funnel', 'funnel-client-class', 'entitlements', 'workspace', 'webhook', 'publishers', 'ssrf-boundary', 'core', 'api', 'openapi', 'oauth', 'pilot', 'retention', 'bulk', 'c6', 'c7', 'deletion-sweep', 'signin-ratelimit', 'fixer3-migration', 'worker-drain', 'trial-end', 'error-visibility', 'deployment-skew.tsx', 'trial-handoff.tsx'];
