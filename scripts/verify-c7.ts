...
async function main() {
  ...
  try {
    ...
    const healthData=await h.json();assert(healthData.migrations.applied>=15);assert.match(healthData.migrations.latest,/0014/);assert('lastTickAt' in healthData.worker);
