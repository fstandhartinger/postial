...
implemented, including public customer approval links. Public API v1 is implemented; the native n8n node is published on npm as `n8n-nodes-postial` 0.2.0 and appears as Postial in n8n.
...
n8n community node: `n8n-nodes-postial` 0.2.0 is published on npm and appears as Postial in n8n.
