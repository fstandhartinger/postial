...
export default function Home() {
  ...
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema).replace(/</g, '\\u003c') }} />
    ...
    <section className="section networks"><h2>{words('Networks', 'H2')}</h2><NetworkAvailability /><Link className="text-link" href="/roadmap">Roadmap and launch notifications →</Link></section>
