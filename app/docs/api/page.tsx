...
export default function ApiDocs() {
  return <article className="legal"><h1>SocialMint REST API v1</h1><p>Automate brand publishing with the Agency plan, including Agency trials. <Link href="/app/settings/api">Manage keys and webhooks</Link> · <a href="/openapi.json">Download OpenAPI 3.1</a></p>
    ...
    <pre className="overflow-x-auto">{JSON.stringify({id: '33333333-3333-4333-8333-333333333333', brand_id: example.brand_id, body: example.body, media_urls: [], link_url: null, scheduled_at: '2026-09-09T12:00:00Z', requires_approval: true, status: 'pending_approval', approval_url: 'https://socialmint.app.mintapis.com/r/<token>', created_at: '2026-09-09T12:00:00Z', updated_at: '2026-09-09T12:00:00Z'}, null, 2)}</pre>
