...
export const metadata = { title: 'Pricing for Bluesky, Mastodon & Telegram agencies', description: 'Starter €19 or Agency €49/month including VAT for Bluesky, Mastodon and Telegram. Login-free Agency approvals. X and Threads await approval.', alternates: { canonical: '/pricing' } };
