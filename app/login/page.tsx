...
export default async function Login({ searchParams }: { searchParams: Promise<{ error?: string; sent?: string; next?: string; plan?: string; callbackUrl?: string }> }) {
