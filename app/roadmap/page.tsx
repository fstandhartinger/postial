...
export const metadata = { title: 'Roadmap | Live networks and what’s next', description: 'Bluesky, Mastodon and Telegram are live. X, Threads and LinkedIn connections are Early access when configured; Instagram and Facebook are planned. Follow network launches.', alternates: { canonical: '/roadmap' } };
